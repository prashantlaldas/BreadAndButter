...
import com.prashantlal.breadandbutter.Model.Cart;
import com.prashantlal.breadandbutter.Prevalent.Prevalent;
import com.prashantlal.breadandbutter.ViewHolder.CartViewHolder;
              ...
              if(dataSnapshot.exists())
              {
                  ...
                  if (shippingState.equals("shipped"))
                  {
                     //txtTotalAmount.setText("Total Amount = ₹" + overTotalPrice);
                      ...
                      Toast.makeText(CartActivity.this, "you can purchase more product, Once you received your first finale order", Toast.LENGTH_SHORT).show();
                  }
